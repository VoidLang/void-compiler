...
public class DereferencePrimitiveTest {
    @Test
    public void testSumMethodWithPointerInputs() {
        Package root = assertDoesNotThrow(() -> Compiler.compile("compiler/DereferencePrimitive.vs"));
